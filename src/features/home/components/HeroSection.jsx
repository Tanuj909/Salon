      ...
      <section className="relative w-full min-h-[100svh] overflow-hidden font-['DM_Sans',sans-serif] bg-black flex flex-col justify-center py-20 px-4">
        ...
        <div className="relative z-[10] w-full max-w-7xl mx-auto flex flex-col items-center text-center mt-8 md:-mt-24">
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-4 animate-fade-up [animation-delay:900ms]">
            <Link
              href="/salons"
              className="px-8 py-4 bg-white/10 hover:bg-white/20 border-2 border-white/30 backdrop-blur-md rounded-full text-white font-bold tracking-widest uppercase text-[10px] transition-all flex items-center gap-2 group"
            >
