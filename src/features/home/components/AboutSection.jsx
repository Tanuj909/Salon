...
const AboutSection = () => {
  return (
    <section id="about" className="pt-4 pb-12 bg-plum/5">
        ...
        <div className="space-y-12 md:space-y-20">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10 md:gap-16">
            ...
            <div className="w-full lg:w-1/2 text-center lg:text-left">
              <h3 className="text-[#B76E4B] font-bold tracking-[0.15em] uppercase text-xs md:text-sm mb-3 md:mb-4">The Experience</h3>
              <h2 className="text-2xl md:text-4xl font-extrabold mb-4 md:mb-6 leading-tight text-[#3c1432]">Elevated Atmosphere for the Modern Client</h2>
              <p className="text-sm md:text-lg text-[#3c1432]/70 mb-4 md:mb-6 leading-relaxed">
              ...
              <p className="text-sm md:text-lg text-[#3c1432]/70 leading-relaxed hidden md:block">
          ...
          {/* Expertise Part */}
          <div className="flex flex-col md:flex-col-reverse lg:flex-row items-center gap-10 md:gap-16">
            <div className="w-full lg:w-1/2 text-center lg:text-left">
              <h3 className="text-[#B76E4B] font-bold tracking-[0.15em] uppercase text-xs md:text-sm mb-3 md:mb-4">The Expertise</h3>
              <h2 className="text-2xl md:text-4xl font-extrabold mb-4 md:mb-6 leading-tight text-[#3c1432]">Master Craftsmanship & Premium Products</h2>
              <p className="text-sm md:text-lg text-[#3c1432]/70 mb-4 md:mb-6 leading-relaxed">
