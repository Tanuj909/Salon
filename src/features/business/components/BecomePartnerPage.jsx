              ...
              <div className="md:w-2/3 p-10 bg-[#fafafa]">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-wrap gap-3 py-2">
                        <button
                          ...
                          className="px-5 py-2.5 bg-white border border-[#C8A951] text-[#C8A951] rounded-lg flex items-center gap-2 text-xs font-semibold hover:bg-[#C8A951] hover:text-[#1C1C1C] transition-all shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                  ...
                  <div className="space-y-4 pt-4">
                    <h3 className="text-xs font-bold uppercase tracking-[0.2em] text-[#C8A951]">Business Categories</h3>
                    {categoriesLoading ? (
                      <div className="flex gap-2">
                        <Loader2 size={16} className="animate-spin text-[#C8A951]" />
                        <span className="text-xs text-[#6b5e52]">Loading categories...</span>
                      </div>
                    ) : (
