...
export default function BecomePartnerPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F3EE] pt-32 pb-24 font-[Jost,sans-serif]">
      <style jsx global>{`
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="relative overflow-hidden bg-white rounded-[2rem] border border-[#C8A951]/20 shadow-[0_20px_50px_-20px_rgba(200,169,81,0.15)]">
          {/* Decorative Background Elements */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#C8A951]/5 rounded-bl-full -mr-20 -mt-20 pointer-events-none" />
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-[#C8A951]/5 rounded-tr-full -ml-16 -mb-16 pointer-events-none" />
