        ...
        <div className="flex gap-3 overflow-x-auto pb-4 scrollbar-hide items-center mb-12">
          ...
          {filters.map((f) => (
            <button
              ...
              className={`py-2.5 px-6 rounded-full border-[1.5px] text-[0.85rem] font-semibold cursor-pointer transition-all duration-200 whitespace-nowrap font-[DM_Sans] ${activeFilter === f
